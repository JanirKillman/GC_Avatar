...
#End Region
    Private Sub WEPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FWB)
        Dim oCRT As CRweap = New CRweap
        oCRT.SetDataSource(Tsetw)
        crView.Visible = True
