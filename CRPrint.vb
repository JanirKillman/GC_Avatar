...
#End Region
    Private Sub CRPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FCRB)
        Dim oCRT As CRcr = New CRcr
        oCRT.SetDataSource(CRrec)
        crView.Visible = True
