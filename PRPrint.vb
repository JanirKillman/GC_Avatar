...
#End Region
    Private Sub PRPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FCEB)
        Dim oCRT As CRpric = New CRpric
        oCRT.SetDataSource(PRrec)
        crView.Visible = True
