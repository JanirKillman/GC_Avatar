...
#End Region
    Private Sub ATPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FUB)
        Dim oCRT As CRart = New CRart
        oCRT.SetDataSource(ATrec)
        crView.Visible = True
