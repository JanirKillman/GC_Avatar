...
#End Region
    Private Sub OGPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FOB)
        Dim oCRT As CRorg = New CRorg
        oCRT.SetDataSource(OGrec)
        crView.Visible = True
