...
#End Region
    Private Sub SKPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FSKB)
        Dim oCRT As CRskill = New CRskill
        oCRT.SetDataSource(SKrec)
        crView.Visible = True
