...
#End Region
    ...
    Private Sub SPPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FSPB)
        Dim oCRT As CRspell = New CRspell
        oCRT.SetDataSource(SPrec)
        crView.Visible = True
