...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.crView.Size = New System.Drawing.Size(944, 448)
        Me.crView.TabIndex = 4
        '
        'NAPrint
        '
...
#End Region
    Private Sub NAPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FNB)
        Dim oCRT As CRnar = New CRnar
        oCRT.SetDataSource(NArec)
        crView.Visible = True
