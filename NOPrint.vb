...
#End Region
    Private Sub NOPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FNOB)
        Dim oCRT As CRnote = New CRnote
        oCRT.SetDataSource(NOrec)
        crView.Visible = True
