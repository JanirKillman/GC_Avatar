...
#End Region
    ...
    Private Sub PEPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.FromArgb(FPEB)
        Dim oCRT As CRper = New CRper
        oCRT.SetDataSource(PErec)
        crView.Visible = True
